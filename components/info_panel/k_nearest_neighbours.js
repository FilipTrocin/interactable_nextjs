export const testimonials =
    [
        {
         icon: "../../../../components/info_panel/icons/user-img.svg",
        ...
        {
         icon: "../info_panel/icons/news-img.svg",
        ...
        {
         icon: "../info_panel/icons/question-img.svg",
        ...
        {
         icon: "../info_panel/icons/location-img.svg",
         title: "Geolocation",
